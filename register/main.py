...
def register(name, id, address, port):
    url = "http://192.168.0.10:8500/v1/agent/service/register"
...
def deregister(id):
    url = f"http://192.168.0.10:8500/v1/agent/service/deregister/{id}"
...
def filter_service(name):
    url = "http://192.168.0.10:8500/v1/agent/services"
    params = {
...
if __name__ == "__main__":
    register("mshop-web", "mshop-web", "192.168.0.14", 50058)
